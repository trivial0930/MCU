...
#   D:/vivado/2025.2/Vivado/bin/vivado.bat -mode batch -source vivado/run_v58_no_ila.tcl -tclargs 300
...
if {![info exists OUT_DIR]} {
    set OUT_DIR [file normalize [file join "D:/vivado_work/routes_ultra" "mcu_fft_v58_octa_pairfold_balanced_${FREQ_MHZ}"]]
}
...
puts "V58 no-ILA board build complete."
