...
#   D:/vivado/2025.2/Vivado/bin/vivado.bat -mode batch -source vivado/run_v57_no_ila.tcl -tclargs 300
...
if {![info exists OUT_DIR]} {
    set OUT_DIR [file normalize [file join "D:/vivado_work/routes_ultra" "mcu_fft_v57_octa_memory_bank_pairfold_${FREQ_MHZ}"]]
}
...
puts "V57 no-ILA board build complete."
