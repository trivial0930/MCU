...
set status_file [file join $base_dir "capture_v60_ila_status.txt"]
set bit_file [file normalize "D:/vivado_work/routes_ultra/mcu_fft_v60_component_owner_300_ila/mcu_fft_board.runs/impl_1/board_top.bit"]
set ltx_file [file normalize "D:/vivado_work/routes_ultra/mcu_fft_v60_component_owner_300_ila/mcu_fft_board.runs/impl_1/debug_nets.ltx"]
set csv_file [file join $base_dir "v60_ila_fast_stop_capture.csv"]
...
if {[catch {
    ...
    log_line $fd "csv=board_validation/v60_ila_fast_stop_capture.csv"
} err]} {
