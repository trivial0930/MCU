...
set OUT_DIR [file normalize "D:/vivado_work/routes_ultra/mcu_fft_v60_component_owner_300_ila"]
set root_dir [file normalize [pwd]]
set reports_dir [file join $root_dir board_validation vivado_ila]
set status_file [file join $reports_dir v60_ila_bitstream_status.txt]
...
if {[catch {
    ...
    report_timing_summary -file [file join $reports_dir v60_ila_timing_summary.rpt]
    report_utilization -file [file join $reports_dir v60_ila_utilization.rpt]
    report_utilization -hierarchical -file [file join $reports_dir v60_ila_utilization_hierarchical.rpt]
    report_drc -file [file join $reports_dir v60_ila_drc.rpt]
    report_methodology -file [file join $reports_dir v60_ila_methodology.rpt]
