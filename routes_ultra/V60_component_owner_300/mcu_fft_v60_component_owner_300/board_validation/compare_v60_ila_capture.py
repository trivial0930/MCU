...
CAPTURE = BOARD / "v60_ila_fast_stop_capture.csv"
EXPECTED = ROOT / "results" / "expected_fft_output.txt"
OUT_COMPARE = BOARD / "v60_hw_compare.csv"
OUT_PROOF = BOARD / "v60_fast_stop_proof.csv"
STATUS = BOARD / "v60_hw_compare_status.txt"
...
def main():
    ...
    summary = [
        ...
        "compare_csv=board_validation/v60_hw_compare.csv",
        "proof_csv=board_validation/v60_fast_stop_proof.csv",
    ]
    STATUS.write_text("\n".join(summary) + "\n", encoding="utf-8")
    print("\n".join(summary))
    if not pass_status:
