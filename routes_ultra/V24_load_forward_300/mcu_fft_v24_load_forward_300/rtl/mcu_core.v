...
module mcu_core(
    ...
    wire load_forward_can_bypass;
    wire [3:0] load_forward_waddr;
    wire signed [24:0] load_forward_wdata;
    wire ex_fwd_rs1_hit;
    wire ex_fwd_rs2_hit;
    wire load_fwd_rs1_hit;
    wire load_fwd_rs2_hit;
    wire wb_fwd_rs1_hit;
    wire wb_fwd_rs2_hit;
    wire cmp_zero_ex;
    wire take_branch_ex;
    ...
    wire ex_load_must_stall = ex_load_will_write && !load_forward_can_bypass;
    wire ex_pending_slow_write = ex_mul_will_write || ex_load_must_stall;
    ...
    assign load_fwd_rs1_hit = load_forward_can_bypass && (load_forward_waddr == rs1_id);
    assign load_fwd_rs2_hit = load_forward_can_bypass && (load_forward_waddr == rs2_id);
    ...
    assign ex_forward_wdata =
        ...
        (ex_opcode == `OP_BL)   ? ({9'd0, ex_pc} + 25'd1) :
                                  alu_fast_y;
    assign load_forward_can_bypass = ex_valid && ex_reg_we && ex_load_will_write && ex_is_test_rom;
    assign load_forward_waddr = ex_rd;
    assign load_forward_wdata = test_rom_read_data;
