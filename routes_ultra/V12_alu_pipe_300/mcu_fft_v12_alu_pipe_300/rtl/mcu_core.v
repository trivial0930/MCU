...
module mcu_core(
    ...
    reg mul_active;
    reg [3:0] mul_rd;
    reg signed [32:0] mul_stage_full;
    ...
    wire take_branch;
    wire signed [24:0] mul_data_start;
    wire signed [7:0] mul_coeff_start;
    wire signed [24:0] mul_stage_y25;
    wire signed [31:0] mul_stage_y;

    assign mul_data_start = rdata1[24:0];
    assign mul_coeff_start = rdata2[7:0];
    assign mul_stage_y25 = mul_stage_full >>> 7;
    assign mul_stage_y = {{7{mul_stage_y25[24]}}, mul_stage_y25};
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (mul_active) begin
                ...
                mul_active <= 1'b1;
                mul_rd <= rd;
                mul_stage_full <= mul_data_start * mul_coeff_start;
            end else begin
