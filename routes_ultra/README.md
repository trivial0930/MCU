...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | V22b_fast_mul2_300 | 官方样例 + 20 组随机 PASS | 173 | 300 MHz | 0.577 us | +0.122 ns | 1053 | 675 | 0 |
...
- 要展示“当前最快 300 MHz 成绩”：优先使用 `V22b_fast_mul2_300`，`cnt_test=173`，按 300 MHz 推算为 `0.577 us`，WNS `+0.122 ns`。
