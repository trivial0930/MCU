...
- 当前最快 timing-clean 候选：`V26_scheduled_mul2_300` / `V28_branch_reduce_300`，`cnt_test=172`，300 MHz，WNS `+0.067 ns`。
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | V26_scheduled_mul2_300 | PASS，未上板 | 172 | 300 MHz | 0.573 us | +0.067 ns | 1050 | 675 | 0 |
| 1 | V28_branch_reduce_300 | PASS，未上板 | 172 | 300 MHz | 0.573 us | +0.067 ns | 1050 | 675 | 0 |
| 3 | V22b_fast_mul2_300 | PASS，已上板 | 173 | 300 MHz | 0.577 us | +0.122 ns | 1053 | 675 | 0 |
| 4 | V22_fast_mul_300 | PASS | 181 | 300 MHz | 0.603 us | +0.089 ns | 1012 | 675 | 0 |
| 5 | V21_forward_stable_300 | PASS | 197 | 300 MHz | 0.657 us | +0.031 ns | 973 | 675 | 0 |
| 6 | V20_forward_300 | PASS | 197 | 300 MHz | 0.657 us | +0.004 ns | 989 | 675 | 0 |
| 7 | V19_pipeline_300 | PASS | 204 | 300 MHz | 0.680 us | +0.121 ns | 860 | 675 | 0 |
...
```powershell
cd routes_ultra\V28_branch_reduce_300\mcu_fft_v28_branch_reduce_300
