...
| 项目 | 路线 | 结果 |
| --- | --- | --- |
| 当前最快且已上板路线 | `V61_testrom_addr_stable_300` | `cnt_test=38`，300 MHz 理论时间 `0.127 us`，no-ILA WNS `+0.162 ns`，no-ILA 下载 PASS，ILA fast-stop 证明 PASS |
| 上一版已上板路线 | `V60_component_owner_300` | `cnt_test=38`，no-ILA 下载 PASS，ILA fast-stop 证明 PASS |
...
V61 是 V60 的 WNS 稳定化版本，速度相同但时序余量更大。V61 已完成板上证明，当前是最快主展示路线。

## 速度榜

| 排名 | 路线 | 状态 | `cnt_test` | MCU 频率 | 理论时间 | WNS | LUT | FF | DSP |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | V61_testrom_addr_stable_300 | PASS，已上板，fast-stop 证明通过，no-ILA 已恢复 | 38 | 300 MHz | 0.127 us | +0.162 ns | 16712 | 13140 | 0 |
...
- `V61_testrom_addr_stable_300/mcu_fft_v61_testrom_addr_stable_300/board_validation/BOARD_VALIDATION_REPORT.md`
...
D:/vivado_work/routes_ultra/mcu_fft_v61_testrom_addr_stable_300_ila/mcu_fft_board.runs/impl_1/board_top.bit
