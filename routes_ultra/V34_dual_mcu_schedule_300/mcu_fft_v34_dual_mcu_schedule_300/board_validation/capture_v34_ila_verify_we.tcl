...
set status_file [file join $base_dir "capture_v34_ila_status.txt"]
set bit_file [file normalize "D:/vivado_work/routes_ultra/mcu_fft_v34_dual_mcu_schedule_300_ila/mcu_fft_board.runs/impl_1/board_top.bit"]
set ltx_file [file normalize "D:/vivado_work/routes_ultra/mcu_fft_v34_dual_mcu_schedule_300_ila/mcu_fft_board.runs/impl_1/debug_nets.ltx"]
set csv_file [file join $base_dir "v34_ila_verify_we_capture.csv"]
...
if {[catch {
    ...
    log_line $fd "csv=board_validation/v34_ila_verify_we_capture.csv"
} err]} {
