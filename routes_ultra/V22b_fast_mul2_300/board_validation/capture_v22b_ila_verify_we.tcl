set base_dir [file normalize "output/hardware_debug/v22b_300MHz_20260704/ila"]
set status_file [file join $base_dir "capture_v22b_ila_status.txt"]
set bit_file [file join $base_dir "board_top_v22b_300m_ila.bit"]
set ltx_file [file join $base_dir "board_top_v22b_300m_ila.ltx"]
set csv_file [file join $base_dir "v22b_ila_verify_we_capture.csv"]
