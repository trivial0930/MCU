...
if {![info exists OUT_DIR]} {
    set OUT_DIR [file normalize [file join "D:/vivado_work/routes_ultra" "mcu_fft_v38_dual_mcu_stage2_wait_reduce_300_stable"]]
}
...
write_board_status $status_file ok "part=$PART_NAME target_period_ns=$TARGET_PERIOD_NS enable_ila=$ENABLE_ILA flatten_hierarchy=$SYNTH_FLATTEN_HIERARCHY max_dsp=$SYNTH_MAX_DSP synth_status=$synth_status impl_status=$impl_status strategy_notes=$impl_notes bit_files=$bit_files ltx_files=$ltx_files"

puts "V38 stable board build complete."
