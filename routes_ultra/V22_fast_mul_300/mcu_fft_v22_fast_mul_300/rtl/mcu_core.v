...
module mcu_core(
    ...
    wire [33:0] mul_x3 = mul_multiplicand + mul_x2;
    wire [33:0] mul_addend =
        (mul_multiplier[1:0] == 2'b00) ? 34'd0 :
        (mul_multiplier[1:0] == 2'b01) ? mul_multiplicand :
        (mul_multiplier[1:0] == 2'b10) ? mul_x2 :
                                          mul_x3;
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (mul_final) begin
                ...
                mul_multiplicand <= mul_multiplicand << 2;
                mul_multiplier <= {2'b00, mul_multiplier[7:2]};
                if (mul_count == 4'd3) begin
                    mul_busy <= 1'b0;
                    mul_final <= 1'b1;
                end else begin
