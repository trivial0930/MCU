...
`ifndef PLL_DIVCLK_DIVIDE
`define PLL_DIVCLK_DIVIDE 1
`endif
`ifndef PLL_CLKFBOUT_MULT
`define PLL_CLKFBOUT_MULT 30
`endif
`ifndef PLL_CLKOUT0_DIVIDE
`define PLL_CLKOUT0_DIVIDE 5
`endif
