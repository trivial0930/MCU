...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `V26_scheduled_mul2_300` | PASS，未上板 | 172 | 0.573 us | +0.067 ns | 1050 | 675 | 0 | 当前最快 timing-clean 候选 |
| `V28_branch_reduce_300` | PASS，未上板 | 172 | 0.573 us | +0.067 ns | 1050 | 675 | 0 | 与 V26 等价的小收益路线 |
...
- 需要“当前最快 timing-clean 候选”：优先尝试 `V28_branch_reduce_300` 或 `V26_scheduled_mul2_300`，但建议先按 V22b 的 ILA 方法补一次实物验证。
