...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | `V61_testrom_addr_stable_300` | PASS，已上板，ILA 证明 fast-stop 非提前停表，no-ILA 已恢复 | 38 | 0.127 us | +0.162 ns | 16712 | 13140 | 0 | 当前最快且 WNS 更稳的已上板路线 |
| 2 | `V60_component_owner_300` | PASS，已上板，ILA 证明 fast-stop 非提前停表 | 38 | 0.127 us | +0.014 ns | 16970 | 13203 | 0 | 上一版最快已上板路线 |
...
- no-ILA 上板：PASS，下载后 `ilas_after_no_ila_program=0`
- ILA 证明版：WNS/TNS = `+0.008 ns / 0.000 ns`
- ILA fast-stop 证明：16 次 verify 写回全覆盖，输出比对 PASS，未提前停表
- 最终状态：已恢复 no-ILA bitstream

关键证据文件：

- `routes_ultra/V61_testrom_addr_stable_300/mcu_fft_v61_testrom_addr_stable_300/board_validation/BOARD_VALIDATION_REPORT.md`
- `routes_ultra/V61_testrom_addr_stable_300/mcu_fft_v61_testrom_addr_stable_300/board_validation/v61_hw_compare_status.txt`
- `routes_ultra/V61_testrom_addr_stable_300/mcu_fft_v61_testrom_addr_stable_300/board_validation/v61_fast_stop_proof.csv`
...
- 最高速度且更稳的已上板主线：V61。它已经完成功能回归、基础指令集测试、300 MHz no-ILA 实现、no-ILA 上板和 ILA fast-stop 证明。
- 上一版最快已上板路线：V60。它和 V61 一样 `cnt_test=38`，但 no-ILA WNS 更贴近 0。
