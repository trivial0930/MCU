...
#   cd routesB
#   vivado -mode batch -source vivado/run_routesB_matrix.tcl
#
...
#   set SYNTH_MAX_DSP 0
#   set JOBS 4
#   set OUT_DIR D:/vivado_work/mcu_route_b_matrix
#   set TARGETS {{120 8.333} {130 7.692}}
...
set route_b_dir [file normalize [pwd]]
if {![info exists OUT_DIR]} {
    set OUT_DIR [file join $route_b_dir build vivado_matrix]
}
...
if {![info exists CANDIDATES]} {
    set CANDIDATES {
        {B1_full_fusion B1_full_fusion/mcu_fft_b1_full_fusion}
        {B2_w1_only_fusion B2_w1_only_fusion/mcu_fft_b2_w1_only_fusion}
        {B3_w3_only_fusion B3_w3_only_fusion/mcu_fft_b3_w3_only_fusion}
        {B4_schedule_only B4_schedule_only/mcu_fft_b4_schedule_only}
    }
}
...
foreach candidate $CANDIDATES {
    ...
    set root_dir [file normalize [file join $route_b_dir $rel_root]]
