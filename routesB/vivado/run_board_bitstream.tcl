# Run from a route B project root, for example:
...
set shared_board_script [file normalize [file join $root_dir .. .. .. routesA vivado create_board_project.tcl]]
if {![file exists $shared_board_script]} {
    set msg "cannot find shared create_board_project.tcl at $shared_board_script"
    puts "ERROR: $msg"
    write_board_status $status_file failed $msg
    error $msg
}

if {[catch {source $shared_board_script} err]} {
...
puts "Route B board build complete."
